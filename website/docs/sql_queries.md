...
-- To use Record Level Index
SET hoodie.enable.data.skipping=true;
SET hoodie.metadata.record.index.enable=true;
SET hoodie.metadata.enable=true;
```

Here is the Example showing Data Skipping using Record Level Index
...
SET hoodie.metadata.record.index.enable=true;
SET hoodie.metadata.enable=true;
SELECT * from hudi_table where uuid = 'c8abbe79-8d89-47ea-b4ce-4d224bae5bfa';
