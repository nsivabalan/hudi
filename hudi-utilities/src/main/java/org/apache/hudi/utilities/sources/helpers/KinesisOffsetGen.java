...
public class KinesisOffsetGen {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(KinesisOffsetGen.class);
  ...
  public static class KinesisShardRange implements java.io.Serializable {
    ...
    public KinesisShardRange(String shardId, Option<String> startingSequenceNumber, Option<String> endingSequenceNumber) {
    ...
    public Option<String> getStartingSequenceNumber() {
      return startingSequenceNumber;
    }

    public Option<String> getEndingSequenceNumber() {
  ...
  public Option<String> getEndpointUrl() {
    return endpointUrl;
  }

  public KinesisSourceConfig.KinesisStartingPositionStrategy getStartingPositionStrategy() {
    return startingPositionStrategy;
  }
