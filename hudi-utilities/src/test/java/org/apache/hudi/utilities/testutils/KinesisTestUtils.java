...
public class KinesisTestUtils {
  ...
  public KinesisTestUtils setup() {
    // Tear down any existing resources to avoid leaking a previous client/container.
    teardown();
  ...
  public String getEndpointUrl() {
    ensureRunning();
    return localStack.getEndpointOverride(LocalStackContainer.Service.KINESIS).toString();
  }
