...
import org.apache.hudi.DataSourceWriteOptions.{DROP_INSERT_DUP_POLICY, FAIL_INSERT_DUP_POLICY, INSERT_DROP_DUPS, INSERT_DUP_POLICY, INSERT_OPERATION_OPT_VAL}
...
class TestHoodieSparkSqlWriter extends HoodieSparkWriterTestBase {
  ...
  def testParametersWithWriteDefaultsUsesFreezeKeyFromGlobalProps(): Unit = {
    ...
    val CANONICAL_KEY = DataSourceWriteOptions.OPERATION.key
